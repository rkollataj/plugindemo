...
[![Build Status](https://github.com/rkollataj/plugindemo/workflows/Main/badge.svg?branch=master)](https://github.com/rkollataj/plugindemo/actions)
...
experimental:
  plugins:
    example:
      moduleName: github.com/rkollataj/plugindemo
      version: v0.2.1
```
...
(In the above example, the `plugindemo` plugin will be loaded from the path `./plugins-local/src/github.com/rkollataj/plugindemo`.)
